...
import { getSolWallet } from "../../utils/solana.js";
...
const KeyCard = ({
  ...
  return (
    <motion.div
      className={`rounded-xl border ${isDarkMode ? "border-gray-700 bg-gray-800" : "border-gray-300 bg-white"
        } p-6 w-full  my-8 relative`}
    ...
    >
      <motion.button
        className={`w-full bg-cream text-gray-800 py-2 px-4 rounded-lg mb-6 font-medium relative overflow-hidden ${isButtonClicked ? "ring-2 ring-blue-400" : ""
          }`}
